import tinycss2
from tempered.src.css.scoped import apply_scope_to_css
...
def test_single_class():
    assert_rule_transformed(scope="scope", css=".div { }", expected=".div.scope { }")
...
def test_two_classes():
    assert_rule_transformed(
        scope="scope", css=".a .b { }", expected=".a.scope .b.scope { }"
    )
...
def test_class_and_psuedo():
    assert_rule_transformed(
        scope="scope", css=".a .b:hover() { }", expected=".a.scope .b.scope:hover() { }"
    )
...
def test_many_classes():
    assert_rule_transformed(
        scope="scope", css=".a .b .c { }", expected=".a.scope .b .c.scope { }"
    )
